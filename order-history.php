    ...
    <body class="cnt-home">
        ...
        <div class="body-content outer-top-xs">
            <div class="container">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="cart-product-sub-total"><?php echo htmlspecialchars($row['pprice']); ?>  </td>
                                                <td class="cart-product-sub-total"><?php echo htmlspecialchars($row['shippingcharge']); ?>  </td>
                                                <td class="cart-product-grand-total"><?php echo htmlspecialchars(($row['qty']*$row['pprice'])+$row['shippingcharge']);?></td>
                ...
                <div class="center" style="margin-left:15%">
                    <img class="center mx-2" src="https://www.knowband.com/blog/wp-content/uploads/2020/03/THANKYOU-PAGE-2.png" />
                </div>
                <div><h1>Your order has successfully placed. Thank you for shopping with us</h1></div><br>
                <h1 class="text-center" style="color:blue;">STAY HOME STAY SAFE</h1><br>
                <h1 class="text-center" style="color:green;">Keep Shopping With OnlineGroceryStore.in</h1>
            </div>
        </div>
