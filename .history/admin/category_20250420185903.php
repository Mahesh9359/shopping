                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                    ...
                                    <?php if(isset($_POST['submit']) && isset($_SESSION['msg'])): ?>
                                    ...
                                    <?php if(isset($_GET['del']) && isset($_SESSION['delmsg'])): ?>
...
?>                                    
                    <tr>
                        ...
                        <td>
                            <a href="edit-category.php?id=<?php echo htmlentities($row['id']); ?>"><i class="icon-edit"></i></a>
                            <a href="category.php?id=<?php echo htmlentities($row['id']); ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="icon-remove-sign"></i></a>
                        </td>
                    </tr>
<?php $cnt++; } ?>
                </tbody>
