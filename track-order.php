...
<?php else: 
    $stmt = $con->prepare("SELECT o.orderDate, o.paymentMethod, o.orderStatus, o.final_amount, 
        ...
        u.name as customerName, u.email, u.contactno, u.shippingAddress, u.shippingCity, 
        u.shippingState, u.shippingPincode
        FROM orders o 
                        ...
                        <div class="row mb-5">
                            <div class="col-md-6 pr-md-5 mb-4 mb-md-0">
                                ...
                                <div style="line-height: 1.8; font-size: 15px;">
                                    ...
                                    <?php echo htmlspecialchars($row['shippingCity']); ?>, 
                                    <?php echo htmlspecialchars($row['shippingState']); ?> 
                                    <?php echo htmlspecialchars($row['shippingPincode']); ?>
                                </div>
                            </div>
                            <?php 
