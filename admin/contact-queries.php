...
if (isset($_GET['markread'])) {
    $id = $_GET['markread'];
    mysqli_query($con, "UPDATE contact_queries SET status='read' WHERE id = '" . $id . "'");
    $_SESSION['msg'] = "Query marked as read!";
}

if (isset($_GET['del'])) {
    mysqli_query($con, "DELETE FROM contact_queries WHERE id = '" . $_GET['id'] . "'");
    $_SESSION['delmsg'] = "Query deleted !!";
}
?>
...
<?php include('include/sidebar.php');?>                
    ...
    <div class="module">
                            <div class="module-head">
                                <h3>Manage Contact Queries</h3>
                            </div>
                            <div class="module-body table">
    <?php if(isset($_GET['markread']))
{?>
